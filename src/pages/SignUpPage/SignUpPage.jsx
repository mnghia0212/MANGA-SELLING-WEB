...
const SignUpPage = () => {
    const [isShowPassword1, setIsShowPassword1] = useState(null);
    const [isShowPassword2, setIsShowPassword2] = useState(null);
      ...
      <div style={{display:'flex', alignItems:'center', justifyContent:'center', background:'#ccc', height:'100vh'}}>
          <div style={{width: '800px', height:'450px', borderRadius:'10px', backgroundColor:'#efefef', display:"flex"}}>
              <WrapperLeft>
                  ...
                  <p style={{fontFamily:'Oswald', fontSize:'13px'}}>Now you can sign an account up !</p>
                  <InputForm placeholder='Enter your email' style={{marginTop:'15px'}}/>
                  <InputForm placeholder='Enter your phone number' style={{marginTop:'15px'}}/>
                  <div style={{position:'relative'}}>
                        <span
                            ...
                            onClick={() => {
                                setIsShowPassword1(prevState => !prevState);
                            }}
                        >
                        {isShowPassword1 === null || isShowPassword1 === false ?
                            <EyeOutlined/>
                        :
                        ...
                        <InputForm 
                            ...
                            type={isShowPassword1 === null || isShowPassword1 ? 'text' : 'password'}
                        />
                  </div>
                  ...
                  <div style={{position:'relative'}}>
                        ...
                        >
                        {isShowPassword2 === null || isShowPassword2 === false ?
                            <EyeOutlined/>
                        :
                            <EyeInvisibleOutlined/>
                        }
                        ...
                        <InputForm 
                            placeholder='Enter your password' 
                            style={{marginTop:'15px'}}
                            type={isShowPassword2 === null || isShowPassword2 ? 'text' : 'password'}
                        />
                  </div>
                  <ButtonComponent
                      size={40} 
                  ...
                  <div style={{marginTop:'15px'}}>
                      <p style={{fontSize:'13px', fontFamily:'Oswald', marginTop:'15px'}}> Already have an account ?
                          <WrapperTextLight onClick={handleCardClick} style={{marginLeft:'5px'}}>Sign in</WrapperTextLight>
                      </p>
                  </div>
